...
package gradle.kotlin.dsl.plugins._890c6a4d854da572f71f31f258577494
...
/**
 * The `io.papermc.paperweight.userdev` plugin implemented by [io.papermc.paperweight.userdev.PaperweightUser].
 */
internal
val `IoPapermcPaperweightPluginGroup`.`userdev`: PluginDependencySpec
    get() = plugins.id("io.papermc.paperweight.userdev")
...
/**
 * The `xyz` plugin group.
 */
@org.gradle.api.Generated
internal
class `XyzPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `xyz`.
 */
internal
val `PluginDependenciesSpec`.`xyz`: `XyzPluginGroup`
    get() = `XyzPluginGroup`(this)


/**
 * The `xyz.jpenilla` plugin group.
 */
@org.gradle.api.Generated
internal
class `XyzJpenillaPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `xyz.jpenilla`.
 */
internal
val `XyzPluginGroup`.`jpenilla`: `XyzJpenillaPluginGroup`
    get() = `XyzJpenillaPluginGroup`(plugins)


/**
 * The `xyz.jpenilla.run-paper` plugin implemented by [xyz.jpenilla.runpaper.RunPaperPlugin].
 */
internal
val `XyzJpenillaPluginGroup`.`run-paper`: PluginDependencySpec
    get() = plugins.id("xyz.jpenilla.run-paper")


/**
 * The `xyz.jpenilla.run-velocity` plugin implemented by [xyz.jpenilla.runvelocity.RunVelocityPlugin].
 */
internal
val `XyzJpenillaPluginGroup`.`run-velocity`: PluginDependencySpec
    get() = plugins.id("xyz.jpenilla.run-velocity")


/**
 * The `xyz.jpenilla.run-waterfall` plugin implemented by [xyz.jpenilla.runwaterfall.RunWaterfallPlugin].
 */
internal
val `XyzJpenillaPluginGroup`.`run-waterfall`: PluginDependencySpec
    get() = plugins.id("xyz.jpenilla.run-waterfall")
